!(function () {
	...
	function m(f, m) {
		...
		try {
			if ("true" === window.localStorage.plausible_ignore)
				return g(f, m, "localStorage flag");
		} catch (e) {}
		var L = {};
		((L.n = f), (L.v = 33));
		var k = m && (m.u || m.url);
		...
		if (
			...
			"function" == typeof i.transformRequest &&
				!(L = i.transformRequest(L)))
		)
	...
	function y(e) {
		if ("auxclick" !== e.type || 1 === e.button) {
			var t,
				n = (function (e) {
					for (; e && (void 0 === e.tagName || !b(e) || !e.href); )
						e = e.parentNode;
					return e;
				})(e.target),
	...
	function S(e) {
				...
				(document.addEventListener("click", y),
					...
					document.addEventListener("submit", function (e) {
						var t,
							n = x(e.target);
						n.name &&
							(((t = { props: n.props }).revenue = n.revenue),
							m(n.name, t));
					}),
		...
		for (
			var a, r = (window.plausible && window.plausible.q) || [], s = 0;
			s < r.length;
			s++
		)
			m.apply(this, r[s]);
